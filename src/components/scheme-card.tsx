            ...
            <CardContent className="py-4 flex flex-col gap-y-2">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <Badge>{scheme.degree}</Badge>
                        <Badge>{scheme.year}</Badge>
                    </div>
                    <div className="flex items-center gap-2">
                        <DropdownMenu>
